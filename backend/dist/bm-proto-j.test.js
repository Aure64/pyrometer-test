...
const bm_proto_j_1 = require("./bm-proto-j");
const block93416_1 = __importDefault(require("./testFixtures/j/block93416"));
const block93416rights_1 = __importDefault(require("./testFixtures/j/block93416rights"));
const block93415erights_1 = __importDefault(require("./testFixtures/j/block93415erights"));
const block93516_1 = __importDefault(require("./testFixtures/j/block93516"));
const block93516rights_1 = __importDefault(require("./testFixtures/j/block93516rights"));
const block93601_1 = __importDefault(require("./testFixtures/j/block93601"));
const block93601rights_1 = __importDefault(require("./testFixtures/j/block93601rights"));
const block96849_1 = __importDefault(require("./testFixtures/j/block96849"));
...
describe("checkBlockBakingRights", () => {
    it("returns baked event for block baked by baker with rights at round 0", () => {
        ...
        const result = (0, bm_proto_j_1.checkBlockBakingRights)({
            baker: delegate,
...
describe("checkBlockEndorsingRights", () => {
    it("returns endorsed event when present in rights and endorsement was made", () => {
        ...
        const result = (0, bm_proto_j_1.checkBlockEndorsingRights)({
...
describe("checkBlockAccusationsForDoubleBake", () => {
    it("returns true when block contains baker accusation", async () => {
        ...
        const result = await (0, bm_proto_j_1.checkBlockAccusationsForDoubleBake)("tz3Q67aMz7gSMiQRcW729sXSfuMtkyAHYfqc", block.operations[2]);
        expect(result).toEqual(true);
    });
    it("returns false when a different baker is accused", async () => {
        const block = block96849_1.default;
        const result = await (0, bm_proto_j_1.checkBlockAccusationsForDoubleBake)("some other baker", block.operations[2]);
    ...
    it("returns false when block contains accusation without metadata", async () => {
        ...
        const result = await (0, bm_proto_j_1.checkBlockAccusationsForDoubleBake)("tz3Q67aMz7gSMiQRcW729sXSfuMtkyAHYfqc", [evidenceNoMetadata]);
        expect(result).toEqual(false);
    });
    it("returns false when block contains no accusation", async () => {
        const block = block93416_1.default;
        expect(block.operations[2].length).toEqual(0);
        const result = await (0, bm_proto_j_1.checkBlockAccusationsForDoubleBake)(block.metadata.baker, block.operations[2]);
        expect(result).toEqual(false);
    });
});
describe("checkBlockAccusationsForDoubleEndorsement", () => {
    ...
    it("returns event if baker is accused", async () => {
        const result = await (0, bm_proto_j_1.checkBlockAccusationsForDoubleEndorsement)("tz1YPSCGWXwBdTncK2aCctSZAXWvGsGwVJqU", [evidence]);
        ...
        const result2 = await (0, bm_proto_j_1.checkBlockAccusationsForDoubleEndorsement)("tz1YPSCGWXwBdTncK2aCctSZAXWvGsGwVJqU", [doublepreEndorsementEvidence]);
        expect(result2).toEqual(events_1.Events.DoublePreendorsed);
    });
    it("returns null if different baker is accused", async () => {
        const result = await (0, bm_proto_j_1.checkBlockAccusationsForDoubleEndorsement)("some other baker", [evidence]);
    ...
    it("returns null if no metadata is included in accusation", async () => {
        ...
        const result = await (0, bm_proto_j_1.checkBlockAccusationsForDoubleEndorsement)("tz1YPSCGWXwBdTncK2aCctSZAXWvGsGwVJqU", [evidenceNoMetadata]);
        expect(result).toEqual(null);
    });
    it("returns null when there are no accusations", async () => {
        const result = await (0, bm_proto_j_1.checkBlockAccusationsForDoubleEndorsement)("some baker", []);
        expect(result).toEqual(null);
    });
});
