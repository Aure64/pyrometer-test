...
import block93416 from "./testFixtures/o/block93416";
import block93416rights from "./testFixtures/o/block93416rights";
import block93415erights from "./testFixtures/o/block93415erights";

import block93516 from "./testFixtures/o/block93516";
import block93516rights from "./testFixtures/o/block93516rights";

import block93601 from "./testFixtures/o/block93601";
import block93601rights from "./testFixtures/o/block93601rights";

import block96849 from "./testFixtures/o/block96849";
...
describe("checkBlockAccusationsForDoubleBake", () => {
  ...
  it("returns false when block contains accusation without metadata", async () => {
    ...
    const contents0 = evidence.contents[0] as DoubleBakingEvidenceO;
...
describe("checkBlockAccusationsForDoubleEndorsement", () => {
  ...
  it("returns event if baker is accused", async () => {
    ...
    const contents0 = evidence.contents[0] as DoubleEndorsementEvidenceO;
